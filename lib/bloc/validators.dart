...
class Validators {
  ...
  final validateCardYear =StreamTransformer<String, String>.fromHandlers(handleData: (cardYear, sink) {
  ...
  final validateCardVerificationValue =StreamTransformer<String, String>.fromHandlers(handleData: (cardCvv, sink){
    if(cardCvv.length > 2){
      sink.add(cardCvv);
    }else {
